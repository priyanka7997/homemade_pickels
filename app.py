...
with app.app_context():
    ...
    products_to_add = [
        ...
        Product(name="Andhra Chicken Pickle", price=599.00, description="Authentic Andhra-style chicken pickle with fiery spices.", image="chicken.jpg", category="Non-veg Pickles"),
        Product(name="Mutton Pickle", price=675.50, description="Tender mutton chunks marinated and pickled in traditional spices.", image="mutton.jpg", category="Non-veg Pickles"),
        Product(name="Fish Pickle", price=545.00, description="Spicy fish pickle made with boneless seer fish and coastal masalas.", image="fish.jpg", category="Non-veg Pickles"),
        Product(name="Prawns Pickle", price=620.25, description="Juicy prawns pickled in tangy and spicy masala for seafood lovers.", image="prawns.jpg", category="Non-veg Pickles"),
        Product(name="Crab Pickle", price=699.99, description="A rich and flavorful crab pickle, slow-cooked with exotic spices.", image="crab.jpg", category="Non-veg Pickles"),
        Product(name="Egg Pickle", price=399.00, description="Boiled eggs pickled in mustard oil and aromatic spices.", image="egg.jpg", category="Non-veg Pickles"),
        Product(name="Dry Fish Pickle", price=480.00, description="Traditional dry fish pickle with a rustic and bold flavor.", image="dryfish.jpg", category="Non-veg Pickles"),
        Product(name="Quail Pickle", price=749.00, description="Exotic quail meat pickle, spiced to perfection.", image="quail.jpg", category="Non-veg Pickles"),
        Product(name="Kerala Fish Pickle", price=560.00, description="Traditional Kerala-style fish pickle made with seer fish, mustard seeds, and coconut oil.", image="kerala_fish.jpg", category="Non-veg Pickles"),
        Product(name="Turkey Pickle", price=799.00, description="Premium turkey pickle with a balanced blend of tang and spice.", image="turkey.jpg", category="Non-veg Pickles"),
        Product(name="Chicken Liver Pickle", price=459.00, description="Unique pickle made from spicy chicken liver masala.", image="liver.jpg", category="Non-veg Pickles"),
        Product(name="Murukku", price=190.00, description="Crunchy South Indian snack made with rice flour and spices.", image="murukku.jpg", category="Snacks"),
        Product(name="Mixture", price=210.00, description="A spicy and crunchy blend of sev, peanuts, and fried lentils.", image="mixture.jpg", category="Snacks"),
        Product(name="Kara Boondi", price=180.00, description="Spicy fried gram flour balls with curry leaves and nuts.", image="kara_boondi.jpg", category="Snacks"),
        Product(name="Ribbon Pakoda", price=200.00, description="Ribbon-shaped crispy snack made with besan and rice flour.", image="ribbon_pakoda.jpg", category="Snacks"),
